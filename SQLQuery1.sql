...
select * from Categoria;
update Categoria
Set Descricao = 'Queijo'	
Where Descricao like 'Cheeses';

/*2°*/
select * from Categoria;
update Categoria
Set Nome_Categoria = 'Confeitos'	
Where Nome_Categoria like 'Confections';

/*3°*/
select * from Categoria;
update Categoria
set Descricao = 'Peixes'
...
Select * from Territorio
update Territorio 
set Territoriodescricao = 'Nova Iorque'
Where Territoriodescricao like 'New York';
...
update Territorio
set Cod_Regiao = 9
where Cod_Territorio < 3000;

/*7°*/
Select * from Territorio
update Territorio
set Territoriodescricao  = 'São Francisco'
where Territoriodescricao like 'San Francisco';

/*8°*/
Select * from Envio
update Envio
set Cidade = 'Leão'
where Cidade like 'Lyon';

/*9°*/
Select * from Envio
update Envio 
set Pais = 'Suécia'
where Pais like 'Switzerland';
...
Select * from Envio
update Envio
set NomeNavio = 'Canarinho'
where NomeNavio like 'Hanari Carnes';
